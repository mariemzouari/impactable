...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 32px;">
  ...
  <div class="content-card">
    ...
    <div class="card-body">
        ...
        <div class="activity-list">
          <?php foreach ($dernieres_candidatures as $candidature): ?>
            <div class="activity-item">
              ...
              <div class="activity-content">
                <h4><?= htmlspecialchars($candidature['prenom'] . ' ' . $candidature['nom']) ?></h4>
                <p><?= htmlspecialchars($candidature['titre']) ?></p>
                <div class="activity-time">
      ...
      <?php else: ?>
        <p style="text-align: center; color: var(--muted); padding: 20px;">Aucune candidature récente.</p>
      <?php endif; ?>
    </div>
  </div>
</div>
