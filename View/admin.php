...
<header class="main-header">
    ...
    <a href="../controller/control.php?action=admin_comments" class="btn-forum">
                        ...
                        <tr class="post-new">
                            ...
                            <td data-label="Actions">
                                <div class="action-buttons">
                                    <a href="../controller/control.php?action=view&id=<?= $post['Id_post'] ?>" class="btn-view" title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="../controller/control.php?action=edit&id=<?= $post['Id_post'] ?>&from=admin" class="btn-edit" title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="../controller/control.php?action=delete&id=<?= $post['Id_post'] ?>&from=admin" class="btn-delete" title="Supprimer" onclick="return confirm('Supprimer ce post ?')">
