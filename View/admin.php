    ...
    <aside class="admin-sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="nav-section">
          ...
          <a href="../controller/control.php?action=admin" class="sidebar-link active">
        ...
        <div class="nav-section">
          ...
          <a href="../controller/control.php?action=search_comments" class="sidebar-link">
    ...
    <main class="admin-main">
      <header class="admin-header">
        ...
        <div class="header-actions">
          ...
          <button class="btn primary" onclick="window.location.href='../controller/control.php?action=search_comments'">
            <i class="fas fa-search"></i>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="table-actions">
                          <a href="../controller/control.php?action=view&id=<?= $post['Id_post'] ?>" 
                             class="btn ghost small" title="Voir">
                            <i class="fas fa-eye"></i>
                          </a>
                          <a href="../controller/control.php?action=edit&id=<?= $post['Id_post'] ?>&from=admin" 
                             class="btn ghost small" title="Modifier">
                            <i class="fas fa-edit"></i>
                          </a>
                          <a href="../controller/control.php?action=delete&id=<?= $post['Id_post'] ?>&from=admin" 
