    ...
    <aside class="admin-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-section">
          ...
          <a href="../controller/control.php?action=admin_comments" class="sidebar-link active">
    ...
    <main class="admin-main">
      <header class="admin-header">
        ...
        <div class="header-actions">
          ...
          <button class="btn primary" onclick="window.location.href='../controller/control.php?action=list'">
            <i class="fas fa-comments"></i>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="table-actions">
                        <a href="../controller/control.php?action=view&id=<?= $comment['Id_post'] ?>" 
