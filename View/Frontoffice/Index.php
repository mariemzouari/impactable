    ...
    <section id="home" class="hero" aria-labelledby="hero-title">
      <div class="hero-content">
        ...
        <div class="hero-cta">
          ...
          <button class="btn offer" id="heroPostOffer">
    ...
    <section id="events" class="section">
      ...
      <div class="timeline">
        <div class="event-item">
          <time datetime="2025-12-15">15 Déc 2025</time>
          <div class="event-content">
            <h4>Atelier Accessibilité Numérique</h4>
            <p>Formation pratique sur l'accessibilité web. En ligne et présentiel avec interprétation LSF.</p>
            <a class="link-muted" href="#">S'inscrire</a>
          </div>
        </div>
        ...
        <div class="event-item">
          ...
          <div class="event-content">
            <h4>Forum des Initiatives Locales</h4>
            <p>Rencontres et networking pour porteurs de projets inclusifs. Accessible PMR.</p>
            <a class="link-muted" href="#">Détails</a>
          </div>
        </div>
        ...
        <div class="event-item">
          ...
          <div class="event-content">
            <h4>Conférence Inclusion & Innovation</h4>
            <p>Présentation des dernières innovations en matière d'inclusion. Sous-titrage en direct.</p>
            <a class="link-muted" href="#">S'inscrire</a>
          </div>
        </div>
      </div>
