...
// Try to include Utils
if (file_exists(__DIR__ . '/../../Controller/Utils.php')) {
    require_once(__DIR__ . '/../../Controller/Utils.php');
} elseif (file_exists(__DIR__ . '/../../Model/utils.php')) {
    ...
    <div class="container">
        <header class="site-header" role="banner">
            ...
            <div class="header-actions">
                <?php if (isset($_SESSION['user_id']) && (class_exists('Utils') ? Utils::isAuthenticated() : isset($_SESSION['user_id']))): ?>
        ...
        <div class="side-panel" id="sidePanel">
            ...
            <nav class="panel-nav">
                <div class="nav-section">
                    ...
                    <a href="index.php#opportunities" class="nav-link">
                        <i class="fas fa-briefcase"></i>
                        <span>Opportunités</span>
                    </a>
                    <a href="index.php#events" class="nav-link">
                    ...
                    <a href="index.php#resources" class="nav-link">
                        <i class="fas fa-book"></i>
                        <span>Ressources</span>
                    </a>
                    <a href="index.php#forum" class="nav-link">
                        <i class="fas fa-comments"></i>
                        <span>Forum</span>
                    </a>
                    <a href="page_reclamation.php" class="nav-link active">
            ...
            <div class="panel-footer">
                <div class="user-profile">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <div class="user-avatar"><?= strtoupper(substr($_SESSION['user_prenom'] ?? 'U', 0, 2)) ?></div>
                        <div class="user-info">
                            <h4><?= htmlspecialchars($_SESSION['user_prenom'] ?? 'Utilisateur') ?></h4>
                        </div>
                    <?php else: ?>
        ...
        <div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
            <p class="subtitle" style="color: #4B2E16; font-size: 1.1em; margin-bottom: 20px;">Votre voix compte. Nous
                sommes là pour vous écouter.</p>
            <div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
                <a href="suivi_reclamation.php" class="dashboard-btn-header"
                    style="background: linear-gradient(135deg, #4B2E16, #5E6D3B); color: white; padding: 10px 20px; border-radius: 20px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
                    <i class="fas fa-search"></i> Suivre ma Réclamation
                </a>
                <a href="demo_ia.php" class="dashboard-btn-header"
                    style="background: linear-gradient(135deg, #b47b47, #4B2E16); color: white; padding: 10px 20px; border-radius: 20px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
                    <i class="fas fa-brain"></i> Démo Priorité IA
                </a>
                <a href="demo_reponse_ia.php" class="dashboard-btn-header"
                    style="background: linear-gradient(135deg, #5E6D3B, #A9B97D); color: white; padding: 10px 20px; border-radius: 20px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
                    <i class="fas fa-robot"></i> Réponse IA
                </a>
            </div>
        </div>

        <!-- Navigation Tabs (kept from original) -->
        ...
        <div class="section active" id="nouvelle-section">
            ...
            <form class="reclamation-form" id="reclamationForm" action="submit_reclamation.php" method="POST"
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="personnesImpliquees" name="personnesImpliquees"
                            placeholder="Nommez les personnes impliquées dans l'incident..."></textarea>
                    </div>

                    <div class="form-group">
                        <label for="temoins">Témoins (optionnel)</label>
                        <textarea id="temoins" name="temoins"
                            placeholder="Nommez les témoins de l'incident..."></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="actionsPrecedentes" name="actionsPrecedentes"
                            placeholder="Décrivez les actions que vous avez déjà entreprises..."></textarea>
                    </div>

                    <div class="form-group">
                        <label for="solutionSouhaitee">Solution souhaitée <span class="required">*</span></label>
                        <textarea id="solutionSouhaitee" name="solutionSouhaitee"
                            placeholder="Quelle solution souhaitez-vous ?"></textarea>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="imagePreview" style="margin-top: 15px; display: none;">
                            <img id="previewImg" src="" alt="Aperçu"
                                style="max-width: 300px; max-height: 200px; border-radius: 10px; border: 2px solid #A9B57D;">
                            <button type="button" onclick="removeImage()"
                                style="margin-top: 10px; padding: 8px 15px; background: #D32F2F; color: white; border: none; border-radius: 8px; cursor: pointer;">
                ...
                <div class="success-message" id="successMessage">
                    ...
                    <!-- Analyse IA -->
                    <div id="iaAnalysisResult"
                        style="margin-top: 20px; background: rgba(255,255,255,0.2); padding: 15px; border-radius: 10px; display: none;">
                    ...
                    <a href="suivi_reclamation.php" id="suiviLink" class="submit-btn"
                        style="margin-top: 20px; text-decoration: none; display: inline-block;">
                        <i class="fas fa-search"></i> Suivre ma réclamation
                    </a>
                </div>
        ...
        <div class="section" id="mes-reclamations-section">
            <div class="mes-reclamations">
                ...
                <div class="search-section">
                    <input type="text" class="search-input" id="searchReclamation"
                ...
                <div class="reclamations-list" id="reclamationsList">
                    ...
                    <?php else: ?>
                        <?php foreach ($reclamations as $rec): ?>
                            ...
                            ?>
                            <div class="reclamation-card" data-id="<?= htmlspecialchars($rec['id']) ?>"
                                data-sujet="<?= htmlspecialchars(strtolower($rec['sujet'])) ?>">
                                ...
                                <div class="reclamation-footer">
                                    <div class="reclamation-badges">
                                        ...
                                        <span
                                            class="badge badge-status badge-<?= strtolower(str_replace(' ', '-', $rec['statut'])) ?>">
                                    ...
                                    <div class="reclamation-actions">
                                        <button class="btn-repondre"
                                            onclick="openReponseModal(<?= $rec['id'] ?>, '<?= htmlspecialchars(addslashes($rec['sujet'])) ?>')">
            ...
            <div class="modal-body">
                ...
                <form id="reponseForm" onsubmit="submitReponse(event)">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="reponseMessage" name="message" placeholder="Écrivez votre réponse ici..."
                            rows="6"></textarea>
                        <div class="char-counter"><span id="reponseCharCount">0</span> / 1000 caractères</div>
                    </div>
                    <input type="hidden" id="reponseUserId" name="userId"
                        value="<?= isset($_SESSION['user_id']) ? htmlspecialchars($_SESSION['user_id']) : '' ?>">
