            ...
            <div class="tracking-timeline">
                ...
                <div class="timeline-steps">
                    ...
                    <div class="timeline-step">
                        <div
                            class="step-icon <?= $etapeActuelle >= 1 ? ($etapeActuelle == 1 ? 'active' : 'completed') : 'waiting' ?>">
                    ...
                    <div class="timeline-step">
                        <div
                            class="step-icon <?= $etapeActuelle >= 2 ? ($etapeActuelle == 2 ? 'active' : 'completed') : 'waiting' ?>">
                    ...
                    <div class="timeline-step">
                        <div
                            class="step-icon <?= $etapeActuelle >= 3 ? ($etapeActuelle == 3 ? 'active' : 'completed') : 'waiting' ?>">
                            <?= $etapeActuelle > 3 ? '<i class="fas fa-check"></i>' : '✅' ?>
                        </div>
                        <div class="step-label">Résolue</div>
                        <div class="step-date">
                            <?= $etapeActuelle >= 3 ? date('d/m/Y', strtotime($reclamation['derniereModification'])) : 'À venir' ?>
                        </div>
                    </div>
                    ...
                    <div class="timeline-step">
                        ...
                        <div class="step-date">
                            <?= $etapeActuelle >= 4 ? date('d/m/Y', strtotime($reclamation['derniereModification'])) : 'À venir' ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="reclamation-details">
                ...
                <div class="details-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span
                            class="badge badge-status badge-<?= strtolower(str_replace(' ', '-', $reclamation['statut'])) ?>">
            ...
            <div class="responses-history">
                ...
                <?php if (empty($reponses)): ?>
                    <div class="no-responses">
                        ...
                        <p>Notre équipe travaille sur votre réclamation. Vous serez notifié dès qu'une réponse sera disponible.
                        </p>
                    </div>
                <?php else: ?>
