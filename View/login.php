...
<div class="container">
    <div class="form-container" style="max-width: 450px; margin-top: 60px;">
        <div class="form-card">
            ...
            <form action="../controller/control.php?action=login" method="POST" id="loginForm">
            ...
            <div class="form-footer" style="margin-top: 24px; text-align: center; flex-direction: column;">
                <p style="color: var(--muted);">
                    ...
                    <a href="../controller/control.php?action=register" style="color: var(--copper); font-weight: 600;">
                        S'inscrire
                    </a>
                </p>
