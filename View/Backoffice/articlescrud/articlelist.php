    ...
    <div class="container">
        <div class="header">
            ...
            <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                <a href="../reclamation_back.php" class="btn-back">
                    ...
                    <?php else: ?>
                        <?php foreach ($list as $article): ?>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars(substr($article['titre'] ?? '', 0, 40)) ?><?= strlen($article['titre'] ?? '') > 40 ? '...' : '' ?>
                                </td>
                                ...
                                <td>
                                    <span
                                        class="status-badge status-<?= htmlspecialchars($article['statut'] ?? 'brouillon') ?>">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <?php endif; ?>
                                        <a href="deletearticle.php?id=<?= $article['id'] ?>" class="btn-delete"
                                            title="Supprimer"
