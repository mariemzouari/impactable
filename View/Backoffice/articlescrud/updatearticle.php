...
<body class="admin-body">
    <header class="admin-header">
        <div class="container">
            ...
            <nav class="admin-nav">
                <a href="../reclamation_back.php" class="nav-link">Dashboard</a>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="form-neon">
                        ...
                        <div class="form-section">
                            ...
                            <div class="stack-2">
                                <div>
                                    ...
                                    <input type="text" class="neon-field" name="titre" id="titre"
                                        value="<?= htmlspecialchars($article['titre'] ?? '') ?>" required>
                                </div>
                                <div>
                                    <label class="form-label">Auteur</label>
                                    <input type="text" class="neon-field" name="auteur" id="auteur"
                                        value="<?= htmlspecialchars($article['auteur'] ?? '') ?>" required>
                                </div>
                                <div>
                                    <label class="form-label">Date de création</label>
                                    <input type="date" class="neon-field" name="date_creation" id="date_creation"
                        ...
                        <div class="form-section">
                            ...
                            <div>
                                ...
                                <textarea class="neon-field" name="contenu" id="contenu"
                            ...
                            <div style="margin-top: 20px;">
                                ...
                                <?php endif; ?>
                                <input type="file" class="neon-field" name="image" id="image"
                                    accept="image/jpeg,image/jpg,image/png,image/gif,image/webp">
                                <small
                                    style="color: var(--text-light); font-size: 0.85rem; display: block; margin-top: 6px;">
                        ...
                        <div class="form-section">
                            ...
                            <div class="stack-2">
                                <div>
                                    ...
                                    <input type="number" class="neon-field" name="auteur_id" id="auteur_id"
                                        value="<?= htmlspecialchars($article['auteur_id'] ?? '') ?>" required>
                                </div>
                                <div>
                        ...
                        <div class="form-section">
                            ...
                            <div>
                                ...
                                <input type="text" class="neon-field" name="tags"
                                    value="<?= htmlspecialchars($tagsValue) ?>" placeholder="Technologie, Gaming, News">
                                <small
                                    style="color: var(--text-light); font-size: 0.85rem; display: block; margin-top: 6px;">
