...
<body class="admin-body">
    ...
    <main class="admin-main">
        <div class="container">
            ...
            <?php if (!$article): ?>
                <section
                    style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius); padding: 40px; text-align: center;">
                    <h2>Article introuvable</h2>
                    <p style="color: var(--text-light);">Aucun article ne correspond à l'identifiant demandé.</p>
                    <a href="articlelist.php" class="btn-outline" style="margin-top: 20px; display: inline-block;">Retour à
                        la liste</a>
                </section>
            <?php else: ?>
                ...
                <section class="article-hero">
                    ...
                    <div>
                        <h1 style="font-family: 'Orbitron', sans-serif; font-size: 2.4rem; margin-bottom: 10px;">
                            <?= htmlspecialchars($article['titre']); ?></h1>
                        ...
                        <div class="meta-grid">
                            ...
                            <div class="meta-tile">
                                <span>Statut</span>
                                <strong
                                    style="text-transform: capitalize;"><?= htmlspecialchars($article['statut'] ?? 'brouillon'); ?></strong>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="detail-card">
                    ...
                    <p style="line-height: 1.8; color: var(--text);">
                        <?= nl2br(htmlspecialchars($article['contenu'] ?? '')); ?></p>
