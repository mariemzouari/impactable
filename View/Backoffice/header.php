      ...
      <div class="admin-content">
        ...
        <?php if (!empty($error)): ?>
          <div class="alert alert-error"
            style="background:#fdecea;color:#9b1c1c;padding:10px;border-radius:6px;margin:12px 0;">
        ...
        <?php if (!empty($success)): ?>
          <div class="alert alert-success"
            style="background:#e9f7ef;color:#1e7f3e;padding:10px;border-radius:6px;margin:12px 0;">
        ...
        <?php if (!empty($stats)): ?>
          <div
            ...
            <div
              style="background:#fffaf5; border:2px solid #5e6d3b; color:#4b2e16; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
                  <p style="margin:0; font-size:0.9rem; color:#6b4b44;">Total Événements</p>
                  <h3 style="margin:0.5rem 0 0 0; font-size:2.5rem; color:#5e6d3b;">
                    <?= htmlspecialchars($stats['total_events']) ?></h3>
                </div>
            ...
            <div
              style="background:#fffaf5; border:2px solid #b47b47; color:#4b2e16; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
                  <p style="margin:0; font-size:0.9rem; color:#6b4b44;">Total Participations</p>
                  <h3 style="margin:0.5rem 0 0 0; font-size:2.5rem; color:#b47b47;">
                    <?= htmlspecialchars($stats['total_participations']) ?></h3>
                </div>
            ...
            <div
              style="background:#fffaf5; border:2px solid #3a4a2a; color:#4b2e16; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
                  <p style="margin:0; font-size:0.9rem; color:#6b4b44;">Événements à Venir</p>
                  <h3 style="margin:0.5rem 0 0 0; font-size:2.5rem; color:#3a4a2a;">
                    <?= count($stats['upcoming_events']) ?></h3>
                </div>
            ...
            <div
              style="background:#fffaf5; border:2px solid #a9b97d; color:#4b2e16; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                <div>
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:2rem; margin-bottom:2rem;">
            ...
            <div
              style="background:#fffaf5; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <h3 style="margin-top:0; color:#4b2e16; border-bottom:2px solid #a9b97d; padding-bottom:12px;">
                Participations par Événement</h3>
            ...
            <div
              style="background:#fffaf5; padding:1.5rem; border-radius:16px; box-shadow:0 8px 22px rgba(75,46,22,0.08);">
              <h3 style="margin-top:0; color:#4b2e16; border-bottom:2px solid #b47b47; padding-bottom:12px;">Distribution
                par catégories</h3>
              ...
              <?php foreach ($events as $event): ?>
                <tr>
                  ...
                  <td class="action-btns">
                    <a href="view_event_participants.php?id=<?= $event['id'] ?>" class="btn primary"
                      title="Voir les participants" style="margin-right: 8px;">
                      <i class="fas fa-users"></i> Participants
                    </a>
                    <a href="evenment_back.php?action=edit&id=<?= $event['id'] ?>" class="btn edit" title="Éditer"><i
                        class="fas fa-pen"></i></a>
                    <a href="evenment_back.php?action=delete&id=<?= $event['id'] ?>" class="btn delete"
                      onclick="return confirm('Voulez-vous vraiment supprimer ?');" title="Supprimer"><i
