                ...
                <?php else: ?>
                    <div id="reponsesList">
                        <?php foreach ($toutesReponses as $rep): ?>
                            <div class="reponse-card" data-reclamation="<?= $rep['reclamation_id'] ?>"
                                ...
                                <div class="reponse-header">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 15px; flex-wrap: wrap;">
                                        ...
                                        <div style="display: flex; gap: 8px;">
                                            <a href="ajouter_reponse_ia.php?reclamation_id=<?= $rep['reclamation_id'] ?>"
                                                style="background: linear-gradient(135deg, #5E6D3B, #A9B97D); color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.8em; text-decoration: none;"
                                                title="Réponse IA">
                                                <i class="fas fa-robot"></i> IA
                                            </a>
                                            <a href="ajouter_reponse.php?reclamation_id=<?= $rep['reclamation_id'] ?>"
                                                style="background: #4b2e16; color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.8em; text-decoration: none;"
