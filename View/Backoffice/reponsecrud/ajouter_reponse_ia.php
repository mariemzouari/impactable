                        ...
                        <div class="card-body">
                            <div class="reclamation-meta">
                                ...
                                <div class="meta-item">
                                    ...
                                    <span
                                        class="priority-badge priority-<?= strtolower($reclamation['priorite'] ?? 'faible') ?>">
                            ...
                            <div class="sentiment-section">
                                <div class="sentiment-info">
                                    ...
                                    <span class="sentiment-badge"
                                        style="background: <?= $sentimentInfo['bg'] ?>; color: <?= $sentimentInfo['couleur'] ?>;">
                            ...
                            <form method="POST" id="reponseForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="message" name="message"
                                        ...
                                        oninput="updateQualityScore()"><?= isset($_POST['message']) ? htmlspecialchars($_POST['message']) : '' ?></textarea>
                                ...
                                <div class="quality-panel" id="qualityPanel">
                                    ...
                                    <div class="quality-bar">
                                        <div class="quality-bar-fill" id="qualityBarFill"
                                            style="width: 0%; background: var(--sage);"></div>
                                    </div>
                            ...
                            <div class="solutions-list">
                                <?php foreach ($reponseGeneree['solutions_disponibles'] as $solution): ?>
                                    <div class="solution-item"
                                        onclick="insertSolution('<?= htmlspecialchars(addslashes($solution)) ?>')">
                                        <i class="fas fa-plus-circle"></i>
                                        <span><?= htmlspecialchars($solution) ?></span>
                                    </div>
                                <?php endforeach; ?>
                                <?php if (empty($reponseGeneree['solutions_disponibles'])): ?>
                                    <p style="color: var(--moss); font-size: 0.9rem;">Aucune solution spécifique pour cette
                                        catégorie.</p>
                                <?php endif; ?>
                            </div>
                        </div>
