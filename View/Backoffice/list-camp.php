            ...
            <div class="admin-content">
                <?php if (isset($_GET['success'])): ?>
                    <div class="alert success">
                        <?php
                        if ($_GET['success'] == 1)
                            echo 'Campagne créée avec succès!';
                        elseif ($_GET['success'] == 2)
                            echo 'Campagne supprimée avec succès!';
                        elseif ($_GET['success'] == 3)
                            echo 'Campagne modifiée avec succès!';
                        ?>
                    </div>
                <?php endif; ?>
                    ...
                    <section class="content-card alert-warning">
                        ...
                        <div class="card-body">
                            <div class="alert-message">
                                <p><strong><?php echo $countProblemes; ?> campagne(s) nécessite(nt) votre attention
                                        :</strong></p>
                                <ul>
                                    <?php foreach ($campagnesProblemes as $campagne):
                                        ...
                                        <li>
                                            ...
                                            <a href="update-camp.php?id=<?php echo $campagne['Id_campagne']; ?>"
                                            ...
                                            <tr class="<?php echo $isProbleme ? 'campagne-probleme' : ''; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <p class="text-muted small">
                                                        <?php echo substr($campagne['description'], 0, 50) . '...'; ?>
                                                    </p>
                                                    <?php if ($isProbleme): ?>
                                                        <span class="badge warning"
                                                            title="Campagne terminée sans atteindre l'objectif">
                                                ...
                                                <td>
                                                    <span
                                                        class="badge"><?php echo ucfirst($campagne['categorie_impact']); ?></span>
                                                </td>
                                                <td><?php echo number_format($campagne['objectif_montant'], 0, ',', ' '); ?> TND
                                                </td>
                                                <td><?php echo number_format($campagne['montant_actuel'], 0, ',', ' '); ?> TND
                                                </td>
                                                <td>
                                                    <div
                                                        style="background: #f0f0f0; border-radius: 10px; height: 8px; width: 100px; margin-bottom: 5px;">
                                                        <div
                                                            style="background: var(--sage); height: 100%; border-radius: 10px; width: <?php echo min($progress, 100); ?>%;">
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="showCampagne.php?id=<?php echo $campagne['Id_campagne']; ?>"
                                                            class="btn small" title="Voir">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="update-camp.php?id=<?php echo $campagne['Id_campagne']; ?>"
                                                            class="btn small secondary" title="Modifier">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="deleteCampagne.php?id=<?php echo $campagne['Id_campagne']; ?>"
