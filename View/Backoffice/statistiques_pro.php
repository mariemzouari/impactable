...
<head>
    ...
    <style>
        ...
        * {
        ...
        .kpi-card.sage::before {
            background: var(--sage);
        }

        .kpi-card.brown::before {
        ...
        .kpi-card.moss .kpi-icon {
            background: rgba(94, 109, 59, 0.15);
            color: var(--moss);
        }

        .kpi-card.copper .kpi-icon {
            background: rgba(180, 123, 71, 0.15);
            color: var(--copper);
        }

        .kpi-card.sage .kpi-icon {
            background: rgba(169, 185, 125, 0.2);
            color: var(--moss);
        }

        .kpi-card.brown .kpi-icon {
            background: rgba(75, 46, 22, 0.12);
            color: var(--brown);
        }
    ...
    <main class="main-content">
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card brown">
                ...
                <div class="kpi-value"><?= $statsPro['temps_moyen_resolution'] ?><small
                        style="font-size:0.35em;color:var(--copper)">j</small></div>
        ...
        <div class="insights-grid">
            <div class="insight-card <?= $statsPro['urgentes_non_resolues'] > 0 ? 'alert' : 'success' ?>">
                <div class="insight-icon">
                    <i
                        class="fas fa-<?= $statsPro['urgentes_non_resolues'] > 0 ? 'exclamation-circle' : 'check-circle' ?>"></i>
                </div>
            ...
            <div class="insight-card info">
                ...
                <div class="insight-value"
                    style="color: <?= $statsPro['tendance'] >= 0 ? 'var(--copper)' : 'var(--moss)' ?>">
            ...
            <div class="insight-card <?= $statsPro['taux_resolution'] >= 70 ? 'success' : 'alert' ?>">
                ...
                <div class="insight-value"
                    style="color: <?= $statsPro['taux_resolution'] >= 70 ? 'var(--moss)' : 'var(--danger)' ?>">
            ...
            <table class="performance-table">
                ...
                <tbody>
                    <?php foreach ($statsPro['performance_categorie'] as $perf): ?>
                        ...
                        ?>
                        <tr>
                            <td><span class="category-badge"><?= htmlspecialchars($perf['categorie'] ?? 'N/A') ?></span>
                            </td>
