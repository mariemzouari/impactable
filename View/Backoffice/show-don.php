                    ...
                    <div class="detail-section" style="grid-column: 1 / -1;">
                        ...
                        <div class="receipt-box">
                            ...
                            <div style="text-align: left; max-width: 400px; margin: 0 auto;">
                                ...
                                <p><strong>Montant:</strong> <?php echo number_format($don['montant'], 2, ',', ' '); ?>
                                    TND</p>
                                <p><strong>Pour la campagne:</strong>
                                    <?php echo htmlspecialchars($don['campagne_titre']); ?></p>
                                <p><strong>Date du don:</strong>
                                    <?php echo date('d/m/Y', strtotime($don['date_don'])); ?></p>
                                <p><strong>Méthode de paiement:</strong> <?php echo ucfirst($don['methode_paiment']); ?>
                                </p>
                            </div>
