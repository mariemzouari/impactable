...
foreach ($statsAvancees['par_priorite'] as $prio) {
    ...
    switch ($prio['priorite']) {
        case 'Urgente':
            $prioriteColors[] = '#D32F2F';
            break;
        case 'Moyenne':
            $prioriteColors[] = '#FF9800';
            break;
        case 'Faible':
            $prioriteColors[] = '#4CAF50';
            break;
        default:
            $prioriteColors[] = '#9E9E9E';
    }
}
    ...
    <aside class="sidebar" style="background: linear-gradient(180deg, #4a5a2f 0%, #3d4a27 100%) !important;">
        <div>
            ...
            <nav class="nav-links" style="padding: 0 15px;">
                <a href="index.php"
                    style="color: rgba(255,255,255,0.85); padding: 14px 20px; border-radius: 10px; margin-bottom: 5px; display: flex; align-items: center; gap: 12px; text-decoration: none;">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
                <a href="statistiques_pro.php" class="active"
                    style="background: rgba(255,255,255,0.2); color: white; padding: 14px 20px; border-radius: 10px; margin-bottom: 5px; display: flex; align-items: center; gap: 12px; text-decoration: none; font-weight: 600;">
        ...
        <footer
            style="color: rgba(255,255,255,0.5); text-align: center; padding: 20px; font-size: 12px; border-top: 1px solid rgba(255,255,255,0.1);">
            © 2025 ImpactAble</footer>
    </aside>
            ...
            <section class="ia-analysis-section">
                ...
                <div class="ia-features">
                    <div class="ia-feature">
                        ...
                        <p>Notre système analyse automatiquement le contenu des réclamations pour détecter l'urgence et
                            assigner une priorité intelligente.</p>
                    </div>
                    <div class="ia-feature">
                        <h4><i class="fas fa-search"></i> Détection de Mots-clés</h4>
                        <p>Plus de 100 mots-clés sont analysés pour identifier les situations urgentes, importantes ou
                            normales.</p>
                    </div>
                    <div class="ia-feature">
                        <h4><i class="fas fa-percentage"></i> Niveau de Confiance</h4>
                        <p>Chaque analyse est accompagnée d'un score de confiance pour garantir la fiabilité des
                            priorisations.</p>
                    </div>
                    <div class="ia-feature">
            ...
            <section class="top-users-list">
                ...
                <?php else: ?>
                    <?php foreach ($statsAvancees['top_utilisateurs'] as $index => $user): ?>
                        <div class="user-item">
                            <div
                                class="user-rank <?= $index === 0 ? 'gold' : ($index === 1 ? 'silver' : ($index === 2 ? 'bronze' : 'default')) ?>">
                                <?= $index + 1 ?>
                            </div>
