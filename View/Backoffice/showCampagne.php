                        ...
                        <div class="campagne-details">
                            <div class="detail-header">
                                ...
                                <div class="detail-badges">
                                    <span
                                        class="badge category"><?php echo ucfirst($campagne['categorie_impact']); ?></span>
                                    <span
                                        class="badge urgency-<?php echo $campagne['urgence']; ?>"><?php echo ucfirst($campagne['urgence']); ?></span>
                                    <span
                                        class="status <?php echo $campagne['statut']; ?>"><?php echo ucfirst($campagne['statut']); ?></span>
                                </div>
                            </div>
