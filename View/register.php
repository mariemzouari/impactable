...
<div class="container">
    <div class="form-container" style="max-width: 600px; margin-top: 60px;">
        <div class="form-card">
            ...
            <form action="../controller/control.php?action=register" method="POST" id="registerForm">
                <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group">
                        <label for="nom">
                            <i class="fas fa-user"></i> Nom
                        </label>
                        <input type="text" name="nom" id="nom" class="input" placeholder="Votre nom" value="<?= isset($old_data['nom']) ? htmlspecialchars($old_data['nom']) : '' ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prenom" id="prenom" class="input" placeholder="Votre prénom" value="<?= isset($old_data['prenom']) ? htmlspecialchars($old_data['prenom']) : '' ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="input" placeholder="votre@email.com" value="<?= isset($old_data['email']) ? htmlspecialchars($old_data['email']) : '' ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="mot_de_passe" id="mot_de_passe" class="input" placeholder="Au moins 6 caractères" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirmer_mot_de_passe" id="confirmer_mot_de_passe" class="input" placeholder="Confirmez votre mot de passe" required>
                </div>
            ...
            <div class="form-footer" style="margin-top: 24px; text-align: center; flex-direction: column;">
                <p style="color: var(--muted);">
                    ...
                    <a href="../controller/control.php?action=login" style="color: var(--copper); font-weight: 600;">
                        Se connecter
                    </a>
                </p>
                <a href="../controller/control.php?action=list" style="color: var(--muted); margin-top: 12px;">
