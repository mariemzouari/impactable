...
<head>
    ...
    <style>
        ...
        .stat-number { font-size: 2em; font-weight: bold; color: var(--sage); margin: 10px 0; }
        .badge.confirmé { background: #d4edda; color: #155724; }
        .badge.en_attente { background: #fff3cd; color: #856404; }
        .badge.annulé { background: #f8d7da; color: #721c24; }
    </style>
</head>
<body>
                ...
                <section class="content-card">
                    <div class="card-body">
                        <div class="stats-grid">
                            ...
                            <div class="stat-card">
                                <div class="stat-number"><?php echo number_format($nombreDons > 0 ? $totalDons / $nombreDons : 0, 2, ',', ' '); ?> TND</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <a href="show-don.php?id=<?php echo $don['Id_don']; ?>" class="btn small">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="edit-don.php?id=<?php echo $don['Id_don']; ?>" class="btn small secondary">
