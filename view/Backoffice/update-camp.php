...
if (
    isset($_POST['Id_campagne'], $_POST['titre'], $_POST['categorie_impact'], $_POST['urgence'], 
    $_POST['description'], $_POST['objectif_montant'], $_POST['date_debut'], $_POST['date_fin'])
) {
    if (
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select" id="categorie_impact" name="categorie_impact">
                                        ...
                                        <option value="alimentation" <?php echo (isset($campagne['categorie_impact']) && $campagne['categorie_impact']=='alimentation')?'selected':''; ?>>Alimentation</option>
                                        <option value="droits_humains" <?php echo (isset($campagne['categorie_impact']) && $campagne['categorie_impact']=='droits_humains')?'selected':''; ?>>Droits humains</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select" id="statut" name="statut">
                                        ...
                                        <option value="objectif_atteint" <?php echo (isset($campagne['statut']) && $campagne['statut']=='objectif_atteint')?'selected':''; ?>>Objectif atteint</option>
                                    </select>
                                </div>
                            </div>
