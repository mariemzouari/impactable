    ...
    public function faireDon($id_campagne, $montant, $message, $methode_paiment, $email, $nom, $telephone = '', $whatsapp_code = '')
    {
        ...
        try {
            ...
            if (!empty($telephone)) {
                ...
                if (empty($whatsapp_code)) {
                    ...
                    if ($result['success']) {
                        ...
                        $errMsg = "Échec WhatsApp: " . ($result['error'] ?? 'Inconnue');
                        error_log("❌ " . $errMsg);
                        return ['error' => $errMsg];
                    }
            ...
            if (!$id_utilisateur) {
                ...
                return ['error' => "Impossible d'identifier un utilisateur système pour ce don."];
            }
            ...
            if (!$campagneData) {
                ...
                return ['error' => "La campagne demandée (ID $id_campagne) n'existe pas."];
            }
            ...
            if (!$success) {
                ...
                $sqlError = implode(", ", $errorInfo);
                error_log("❌ Erreur insertion don: " . $sqlError);
                return ['error' => "Erreur technique lors de l'enregistrement: " . $sqlError];
            }
            ...
            if (!$update_success) {
                ...
                return ['error' => "Erreur lors de la mise à jour du montant de la campagne."];
            }
            ...
            return ['error' => "Une exception est survenue: " . $e->getMessage()];
        }
    }
