...
if (
    isset($_POST['id'], $_POST['sujet'], $_POST['description'], $_POST['categorie'],
          $_POST['priorite'], $_POST['statut'], $_POST['utilisateurId'])
) {
    if (
    ...
    <div class="container">
        ...
        <form action="" method="POST" id="updateReclamationForm" onsubmit="return validateUpdateReclamationForm(event)">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description"><?= htmlspecialchars($reclamation['description'] ?? '') ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="utilisateurId" id="utilisateurId" value="<?= $reclamation['utilisateurId'] ?? '' ?>">
            </div>

            <div class="form-group">
                <label><i class="fas fa-user-tie"></i> Agent attribué (optionnel)</label>
                <input type="text" name="agentAttribue" value="<?= htmlspecialchars($reclamation['agentAttribue'] ?? '') ?>">
            </div>
