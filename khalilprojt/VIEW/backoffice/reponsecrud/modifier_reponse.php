            ...
            <?php else: ?>
                ...
                <form method="POST" action="" id="modifierReponseForm" onsubmit="return validateModifierReponseForm(event)">
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" placeholder="Écrivez votre réponse ici..."><?= isset($_POST['message']) ? htmlspecialchars($_POST['message']) : htmlspecialchars($reponse['message']) ?></textarea>
