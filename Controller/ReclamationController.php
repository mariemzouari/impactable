...
class ReclamationController
{
    ...
    {
        $sql = "INSERT INTO reclamation (sujet, description, categorie, priorite, statut, dateCreation, derniereModification,
utilisateurId, agentAttribue, image, nom, prenom, email, telephone, lieu, dateIncident, typeHandicap,
personnesImpliquees, temoins, actionsPrecedentes, solutionSouhaitee)
VALUES (:sujet, :description, :categorie, :priorite, :statut, :dateCreation, :derniereModification, :utilisateurId,
:agentAttribue, :image, :nom, :prenom, :email, :telephone, :lieu, :dateIncident, :typeHandicap, :personnesImpliquees,
:temoins, :actionsPrecedentes, :solutionSouhaitee)";
    ...
    public function listReclamations()
    {
        $sql = "SELECT r.*, u.nom as user_nom, u.prenom as user_prenom 
                FROM reclamation r 
                LEFT JOIN utilisateur u ON r.utilisateurId = u.Id_utilisateur 
